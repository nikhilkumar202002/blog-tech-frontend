        ...
        >
            ...
            {activeImage && (
                <div className="absolute inset-0 z-0 overflow-hidden">
                    <div
                        className="w-full h-full bg-cover bg-right md:bg-right-top bg-no-repeat bg-fixed transition-all duration-700"
                    ...
                    <div className="absolute top-0 bottom-0 left-0 w-full md:w-[50%] bg-gradient-to-r from-black via-black/60 to-transparent pointer-events-none opacity-85 z-1" />
                </div>
            )}
            ...
            <div className="site-container relative z-10 w-full py-20 pt-28">
                <div className="max-w-xl">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight text-white font-[var(--font-dm-sans)] mb-1 drop-shadow-md">
                        {titlePrefix}
                        {titleHighlight && (
                            <span
