...
export interface AurownSecurityProps {
  className?: string;
}

const AurownSecurity: React.FC<AurownSecurityProps> = ({ className = "" }) => {
  return (
    <section
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-stone-600 text-base sm:text-lg font-[var(--font-inter)] font-normal leading-relaxed mb-4">
              Aurown is designed with secure and private access for business owners, with role-based access supporting controlled access to business information.
            </p>

            {/* Paragraph 2 */}
            <p className="text-stone-600 text-base sm:text-lg font-[var(--font-inter)] font-normal leading-relaxed">
              This helps businesses maintain appropriate access across their management environment.
            </p>
          </motion.div>
